      ...
      <main>
        <Typography variant="h5" className={classes.divHeading}>
          <b>
            ...
            of jumbled thoughts that may be crowding your mind and causing
            stress!
          </b>
        </Typography>
        <br />
...
const featuredPosts = [
  {
    title:
      "Yoga and Spirituality - AI Yoga Pose Detector (Virtual Fitness Coach)",
    link: "https://yogamodule.s3.amazonaws.com/YOGA+module/learn.html",
    description: "Points - 1500",
    image:
      "https://betterme.world/articles/wp-content/uploads/2020/12/shutterstock_665429929-740x451.jpg",
  ...
  },
  {
    ...
    image:
      "https://media.istockphoto.com/vectors/mindfulness-meditation-and-yoga-background-in-pastel-vintage-colors-vector-id1152829238?k=20&m=1152829238&s=170667a&w=0&h=u1pVjWhiQ8BTan7yfN-EERQmDLfsCZ4PWs7f67a9XM0=",
    imageText: "Artists name",
    readmore:
...

  {
    ...
    image:
      "https://101yogasan.com/wp-content/uploads/2020/04/Focused-Meditation.jpg",
    imageText: "Artists name",
    readmore:
...

  {
    ...
    link: "/#/breathing",
    description: "Points - 2000",
    image:
      "https://vedicpaths.com/wp-content/uploads/2020/04/healinghypnosis.jpg",
    imageText: "Artists name",
    readmore:
  ...
  },
  {
    ...
    link: "/#/breathing",
    description: "Points - 800",
    image:
      "https://cf.ltkcdn.net/stress/images/std/178976-425x290r1-lying-down.jpg",
    imageText: "Artists name",
    readmore:
