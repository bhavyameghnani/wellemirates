    ...
    <React.Fragment>
      ...
      <main>
        <Typography variant="h5" className={classes.divHeading}>
          <b>
            Explore the many ways you can earn loyalty points & coupons with
            DASH Platform!
          </b>
        </Typography>
        <br />
...
const featuredPosts = [
  {
    ...
    description: "Discount - ₹600",
    image:
      "https://d168jcr2cillca.cloudfront.net/uploadimages/vouchers/promocode-130212-CafeCoffeeDay_600x800_Banner4.jpg",
  ...
  {
    title: "Burger King",
    description: "Discount - ₹900",
    image:
      "https://cdn.zouton.com/images/originals/blog/BurgerKingPrintableCoupons02_1619174502_1619591461_1624264654.png",
    imageText: "Artists name",
    readmore:
  ...
  {
    title: "Hershey",
    description: "Discount - ₹1500",
    image:
      "https://www.chocolateworld.com/content/dam/chocolateworld/en_us/images/shop/HCW-Coupon-Experience.jpg?hei=570&wid=570&fmt=jpg",
    imageText: "Artists name",
    readmore:
...

  {
    ...
    image:
      "https://i.pinimg.com/originals/97/46/4c/97464cc8f72681a2ca4f5805a3830ae9.jpg",
    imageText: "Artists name",
    readmore:
